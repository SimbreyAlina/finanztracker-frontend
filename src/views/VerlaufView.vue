...
// Filtert die Liste UND sortiert sie so, dass das Neueste oben steht
const filteredEntities = computed(() => {
  const query = searchQuery.value.toLowerCase().trim()

  // 1. Schritt: Filtern nach Suchbegriff
  ...
  // 2. Schritt: Liste umdrehen, damit die neuesten Einträge oben landen
  // [...filtered] erstellt eine Kopie, damit das originale Array nicht verändert wird
